export default function Markdown() {
  return (
    <section className="h-[calc(100vh-50px)] bg-almost-black border-r-2 border-r-gray col-span-2 md:col-span-1">
      <div
      ...
      <textarea className="font-roboto-mono text-light-gray-2 p-4 pt-2  bg-inherit resize-none w-full outline-none h-[92.5%]"></textarea>
    </section>
  );
}
